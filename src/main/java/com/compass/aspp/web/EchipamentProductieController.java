...
import com.compass.aspp.domain.Operatiune;
import com.compass.aspp.domain.StatusEchipament;
...
@Controller
@RooWebScaffold(path = "echipamentproducties", formBackingObject = EchipamentProductie.class)
